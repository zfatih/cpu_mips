...
signal sa_idex_u_mux_b_control : std_logic;
...
begin
	...
	k_preg_idex : preg_idex port map(sa_ifid_u_idex_npc, sa_wait_ifid_u_idex, sa_sign_extend_u_idex,sa_registara_u_idex_a, sa_registara_u_idex_b, sa_idex_u_mux_a_npc, sa_idex_u_exmem_ir, sa_idex_u_mux_a_a, sa_idex_u_mux_b_i_exmem_b, sa_idex_u_mux_b_imm, sa_idex_u_mux_b_control, sa_idex_u_alu_control, clk);
	
	k_mux_a : mux_a port map(sa_idex_u_mux_a_npc, sa_idex_u_mux_a_a, '0', sa_mux_a_u_alu_a);
	
	k_mux_b : mux_b port map(sa_idex_u_mux_b_i_exmem_b, sa_idex_u_mux_b_imm, sa_idex_u_mux_b_control, sa_mux_b_u_alu_b);
	
	k_alu : alu port map(sa_mux_a_u_alu_a, sa_mux_b_u_alu_b, sa_idex_u_alu_control, sa_alu_u_exmem_output, sa_alu_flagovi);
	
	k_preg_exmem : preg_exmem port map('0', sa_alu_u_exmem_output, sa_idex_u_mux_b_i_exmem_b, sa_idex_u_exmem_ir, sa_exmem_u_mem_podataka_b, sa_exmem_u_wait_ir, sa_exmem_gran_out, sa_exmem_u_mem_podataka_i_mux_npc_i_memwb_aluoutput, sa_exmem_control, clk);
	...
	k_preg_memwb : preg_memwb port map(sa_mem_podataka_u_memwb_data_out, sa_wait_u_memwb_aluoutput, sa_wait_u_memwb_ir, sa_memwb_u_mux_wb_data_out, sa_memwb_u_mux_wb_aluoutput, sa_memwb_u_registre_adresa, sa_memwb_u_registre_control, sa_memwb_u_mux_wb_control, clk);
